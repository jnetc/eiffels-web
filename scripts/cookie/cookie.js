...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    acceptCookieBtn === null || acceptCookieBtn === void 0 ? void 0 : acceptCookieBtn.addEventListener('click', () => setCookie('accepted', '1', 1));
    ...
    declineCookieBtn === null || declineCookieBtn === void 0 ? void 0 : declineCookieBtn.addEventListener('click', () => setCookie('declined', '1', 0.001));
});
